...
<template>
  <div class="min-h-screen bg-gray-50 p-4 sm:p-6 pt-24 sm:pt-28">
      ...
      >
        ...
        <div class="p-5">
          ...
          <p class="text-sm text-gray-600 line-clamp-2">
            {{ client.institution || 'Tidak ada institusi' }}
          </p>
        </div>
      </div>
    </div>
    ...
    <div v-else class="text-center py-20">
      <i class="fa-solid fa-users text-gray-400 mx-auto mb-4 w-16 h-16 text-4xl"></i>
          ...
          <div class="flex gap-3 pt-4">
            ...
            >
              ...
              <span v-else class="flex items-center justify-center gap-2">
                <i class="fa-solid fa-spinner animate-spin h-4 w-4"></i>
                Menyimpan...
              </span>
            </button>
          </div>
