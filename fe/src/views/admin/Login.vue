            ...
            <div class="bg-white rounded-xl shadow-2xl p-10">
                ...
                <form @submit.prevent="handleSubmit" class="space-y-5">
                    ...
                    <button type="submit" :disabled="isLoading"
                        class="w-full py-3 px-4 bg-primary text-white rounded-lg font-bold hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed transition">
