<template>
    <div class="image-upload-container">
        ...
        <div v-if="previewUrl" class="mb-4">
            <div class="relative w-full sm:w-auto inline-block">
                <img :src="previewUrl" :alt="label" class="w-full sm:max-w-md h-auto rounded-lg shadow-md"
                    :style="{ maxHeight: responsivePreview ? '200px' : maxPreviewHeight }" />
        ...
        <div v-if="!previewUrl"
            ...
            @click="triggerFileInput" @drop.prevent="handleDrop" @dragover.prevent="dragOver = true"
        ...
        <!-- Hidden File Input -->
        <input :id="id" ref="fileInput" type="file" :accept="accept" class="hidden" @change="handleFileChange" />
