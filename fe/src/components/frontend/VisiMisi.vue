    ...
    <section class="relative py-10 md:py-14 lg:py-15 bg-white overflow-hidden scroll-mt-[100px] md:scroll-mt-[100px]"
        ...
        <div class="container mx-auto px-4">
            ...
            <template v-if="isLoading || !visiMisi">
                <!-- Skeleton cards -->
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 mb-12 lg:mb-16">
                    <!-- Vision Skeleton (Left) -->
                    <div class="relative p-6 md:p-8 lg:p-8 bg-primary text-white rounded-xl shadow-xl overflow-hidden">
                        <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-secondary to-secondary/30">
                        </div>
                        <div class="mb-5 lg:mb-6">
                            <div
                                class="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-secondary/20 rounded-full flex items-center justify-center mb-3 lg:mb-4 animate-pulse">
                            </div>
            ...
            <template v-else>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-18 mb-16 lg:mb-20">
                    ...
                    <div
                        ...
                        <div>
                            <p class="text-sm md:text-base lg:text-lg leading-relaxed text-white">
                                {{ visiMisi.vision }}
                            </p>
                        </div>
                    </div>
