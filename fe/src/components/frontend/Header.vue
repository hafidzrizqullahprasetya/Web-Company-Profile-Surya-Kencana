...
<template>
    <header id="header" :class="[
        ...
        <div class="relative">
            ...
            <div class="mobile-menu fixed inset-0 z-[99] invisible opacity-0 transition-all duration-300 lg:hidden pointer-events-none"
                :class="{ 'visible opacity-100 pointer-events-auto': isMobileMenuOpen }">
                <div class="mobile-menu-overlay absolute inset-0 bg-black/70 backdrop-blur-sm"
                    @click="toggleMobileMenu"></div>
                <div class="mobile-menu-content absolute top-0 right-0 w-[85%] max-w-sm h-full bg-secondary p-6 sm:p-8 overflow-y-auto transform translate-x-full transition-transform duration-300"
                    ...
                    <ul class="mobile-menu-list list-none p-0 m-0 space-y-1">
                        <li>
                            <a href="#home" @click="
                                (e) => {
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Home</a>
                        </li>
                        <li>
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">About
                                Us</a>
                        </li>
                        <li>
                            <a href="#produk" @click="
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Products</a>
                        </li>
                        <li>
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Gallery</a>
                        </li>
                        <li>
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Clients</a>
                        </li>
                        <li>
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Testimonials</a>
                        </li>
                        <li>
                            <a href="#kontak" @click="
                                (e) => {
                            ...
                            "
                                class="mobile-nav-link block text-white text-base font-semibold py-3 px-4 rounded-lg border-b border-white/10 uppercase transition-all duration-300 hover:bg-white/10 hover:text-cream hover:pl-6">Contact</a>
                        </li>
                    </ul>

                    <div class="mobile-menu-footer mt-10 pt-5 border-t border-white/10">
                        <div class="flex flex-col gap-3">
                            <BadgeButton href="/login" :variant="isOnPrimarySection ? 'default' : 'inverted'"
                                class="w-full">
                                <span>Admin Login</span>
