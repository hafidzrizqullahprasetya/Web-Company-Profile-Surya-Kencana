...
<template>
    <section class="relative py-10 md:py-14 lg:py-15 bg-primary scroll-mt-[155px] md:scroll-mt-[155px]" id="riwayat">
        <div class="container mx-auto px-4">
            <SectionTitle :label="siteSettings?.riwayat_label" :title="siteSettings?.riwayat_title"
                :icon="['fas', 'images']" label-variant="inverted" title-variant="white"
                ...
                <div class="relative w-full max-w-7xl overflow-hidden">
                    ...
                    <div class="flex transition-transform duration-700 ease-in-out"
                        ...
                        <div v-for="(page, pageIndex) in paginatedItems" :key="`page-${pageIndex}`"
                            ...
                            <div
                                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 lg:gap-7 px-2 md:px-4">
                                ...
                                <template v-else>
                                    <div v-for="item in page" :key="item.id"
                                        ...
                                        <div class="p-5 pb-6">
                                            <h3
                                                class="text-lg md:text-xl font-epilogue font-bold uppercase tracking-wide mb-2 text-primary">
                                                {{ item.judul }}
                                            </h3>
